...
class TicketResolution(Base):
    ...
    def __repr__(self):
        return f"<TicketResolution(ticket_id='{self.ticket_id}', method='{self.resolution_method}', confidence='{self.confidence}')>"
...
class ConversationSummary(Base):
    ...
    message_count = Column(String, nullable=False)
    created_at = Column(DateTime, default=func.now())

    ticket = relationship("Ticket")

    def __repr__(self):
        return f"<ConversationSummary(ticket_id='{self.ticket_id}', messages={self.message_count})>"
